...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='experiments/tuab_lp_feat_only/features')
    parser.add_argument('--batch_size', type=int, default=128)
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument('--num_workers', type=int, default=8)
    parser.add_argument('--tiny', action='store_true', help='Use tiny dataset for debugging')
    ...
    if args.tiny:
        print("Using TINY dataset (100 samples)...")
