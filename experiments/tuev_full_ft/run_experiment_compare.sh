...
# Paths
OUTPUT_DIR="experiments/tuev_full_ft/results_compare"
# CHANGED: config to TUEV
CONFIG="configs/finetune_tuev.yaml"
# CHANGED: dataset dir to TUEV
...
# === Execution ===
echo "=== Starting Full Fine-tuning Comparative Experiment (TUEV) ===" | tee -a "$LOG_FILE"
